...
<main class="design-page">
  ...
  <section class="design-section">
    ...
    <div class="design-flex container grid grid-col3 grid-1col">
      <?php
      $dropdown = new WP_Query(array(
        'post_type' => 'design-card',
        'posts_per_page' => -1,
      ));
    ...
    <div class="services-btn">
      <a class="services-btn btn" href="<?php echo site_url('/contact-us/') ?>">See More Services</a>
    </div>
  </section>
  <section>
